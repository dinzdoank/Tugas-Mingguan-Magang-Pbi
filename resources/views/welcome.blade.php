...
<body>
    ...
    <div id="productModal" class="modal">
        <div class="modal-content">
            ...
            <h3 id="modalTitle"></h3>
            <img id="modalImage" src="../Asset/gambar4.png" alt="Product Image" style="width:100%; height:auto;">
    ...
    <section id="products">
        ...
        <div class="product-list">
            @foreach($featuredProducts as $product)
                <article class="product-item animate-on-scroll">
                    <h3>{{ $product->name }}</h3>
                    @if($product->image)
   ...
   <!-- Section informasi atau testimoni -->
